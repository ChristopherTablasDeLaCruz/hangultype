  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-200 font-sans selection:bg-cyan-500/30 relative overflow-hidden">
      ...
      <main className="pt-12 px-6 max-w-4xl mx-auto relative z-10 pb-20">
        ...
        {/* Profile Header */}
        <div className="mb-12">
          <h1 className="text-4xl font-bold text-white mb-3 tracking-tight">Performance Metrics</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          ...
          <div className="p-6 bg-slate-900/40 border border-white/5 rounded-2xl backdrop-blur-md">
            <div className="text-xs font-mono text-slate-500 uppercase tracking-widest mb-4">Modules Completed</div>
            <div className="text-4xl font-bold text-white font-mono">
              {completedCount} <span className="text-lg text-slate-600 font-sans font-normal">/ {totalLessonCount}</span>
            </div>
          </div>

          {/* WPM Card */}
          <div className="p-6 bg-slate-900/40 border border-white/5 rounded-2xl backdrop-blur-md">
            <div className="text-xs font-mono text-slate-500 uppercase tracking-widest mb-4">Avg Speed</div>
            <div className="text-4xl font-bold text-cyan-400 font-mono">
              {avgWpm} <span className="text-lg text-cyan-500/30 font-sans font-normal">WPM</span>
            </div>
          </div>

          {/* Accuracy Card */}
          <div className="p-6 bg-slate-900/40 border border-white/5 rounded-2xl backdrop-blur-md">
            <div className="text-xs font-mono text-slate-500 uppercase tracking-widest mb-4">Accuracy</div>
            <div className="text-4xl font-bold text-violet-400 font-mono">
              {avgAccuracy}<span className="text-2xl">%</span>
            </div>
          </div>
        </div>
