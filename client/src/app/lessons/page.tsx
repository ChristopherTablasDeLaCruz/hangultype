...
export default function LessonsPage() {
  ...
  // --- Helper Functions ---
  const isLessonCompleted = (lesson: Lesson) => completedLessons.includes(lesson.id);
  const progressPercentage = lessons.length > 0 ? (completedLessons.length / lessons.length) * 100 : 0;

  const getDifficultyBadge = (difficulty: number) => {
    const labels: Record<number, string> = { 1: "Beginner", 2: "Easy", 3: "Medium", 4: "Hard", 5: "Expert" };
  ...
  const phaseConfig = [
    { key: "foundation", title: "Foundation", description: "Master the basic jamo", number: 1 },
    { key: "syllables", title: "Syllables", description: "Combine jamo into blocks", number: 2 },
    { key: "words", title: "Words", description: "Real vocabulary practice", number: 3 },
    { key: "sentences", title: "Sentences", description: "Full sentence flow", number: 4 },
    { key: "advanced", title: "Advanced", description: "Complex paragraphs", number: 5 },
  ];
      ...
      <main className="max-w-6xl mx-auto px-6 pt-12">
        ...
        <div className="space-y-20">
          {phaseConfig.map((phase) => {
            const groupLessons = phaseGroups[phase.key as keyof typeof phaseGroups];
            if (groupLessons.length === 0) return null;

            return (
              <div key={phase.key} className="animate-in fade-in slide-in-from-bottom-8 duration-700">
                {/* Phase Title */}
                <div className="flex items-center gap-4 mb-8 border-l-2 border-cyan-500/30 pl-4">
                  <div>
                    <h2 className="text-2xl font-bold text-slate-200">{phase.title}</h2>
                    <p className="text-slate-500 text-sm font-mono tracking-wide">{phase.description.toUpperCase()}</p>
                  </div>
                </div>
                    ...
                    return (
                      ...
                      >
                        <div className="flex justify-between items-start mb-4">
                          <span className={`font-mono text-[10px] tracking-widest ${completed ? "text-emerald-500" : "text-slate-500 group-hover:text-cyan-400"}`}>
                            ID: {lesson.id}
                          </span>
                          {completed && (
                            <span className="text-emerald-400 text-lg shadow-emerald-500/50 drop-shadow-sm">✓</span>
                          )}
                        </div>

                        <h3 className={`font-bold mb-2 text-lg ${completed ? "text-emerald-100" : "text-slate-200 group-hover:text-white"}`}>
                          {lesson.title}
                        </h3>
                        ...
                        <div className="flex items-center justify-between mt-auto pt-4 border-t border-white/5 group-hover:border-white/10 transition-colors">
                          <div className={`px-2 py-0.5 rounded text-[10px] font-mono border ${badge.style}`}>
          ...
          <div className="mt-24 opacity-60 hover:opacity-100 transition-opacity duration-700 animate-in fade-in slide-in-from-bottom-12">
            ...
            <div className="flex items-center gap-4 mb-8 border-l-2 border-slate-800 pl-4">
              <div>
                <h2 className="text-2xl font-bold text-slate-500 italic">Future Sectors</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 pb-20">
              ...
              <div className="p-6 rounded-xl border border-white/5 border-dashed bg-slate-900/10 flex flex-col justify-center items-center text-center group cursor-not-allowed">
                ...
                <h3 className="text-slate-500 font-bold text-sm mb-1 uppercase tracking-tight group-hover:text-slate-400">Essential Words (1)</h3>
                <p className="text-slate-700 font-mono text-[10px]">CORE_NOUNS</p>
              </div>
              ...
              <div className="p-6 rounded-xl border border-white/5 border-dashed bg-slate-900/10 flex flex-col justify-center items-center text-center group cursor-not-allowed">
                ...
                <h3 className="text-slate-500 font-bold text-sm mb-1 uppercase tracking-tight group-hover:text-slate-400">Essential Words (2)</h3>
                <p className="text-slate-700 font-mono text-[10px]">PEOPLE_&_PLACES</p>
              </div>
              ...
              <div className="p-6 rounded-xl border border-white/5 border-dashed bg-slate-900/10 flex flex-col justify-center items-center text-center group cursor-not-allowed">
                ...
                <h3 className="text-slate-500 font-bold text-sm mb-1 uppercase tracking-tight group-hover:text-slate-400">Numbers & Time</h3>
                <p className="text-slate-700 font-mono text-[10px]">COUNTING_SYSTEMS</p>
              </div>
              ...
              <div className="p-6 rounded-xl border border-white/5 border-dashed bg-slate-900/10 flex flex-col justify-center items-center text-center group cursor-not-allowed">
                ...
                <h3 className="text-slate-500 font-bold text-sm mb-1 uppercase tracking-tight group-hover:text-slate-400">Food & Cafe</h3>
                <p className="text-slate-700 font-mono text-[10px]">ORDERING_ESSENTIALS</p>
              </div>
              ...
              <div className="p-6 rounded-xl border border-white/5 border-dashed bg-slate-900/10 flex flex-col justify-center items-center text-center group cursor-not-allowed">
                ...
                <h3 className="text-slate-500 font-bold text-sm mb-1 uppercase tracking-tight group-hover:text-slate-400">Common Greetings</h3>
                <p className="text-slate-700 font-mono text-[10px]">SOCIAL_BASICS</p>
              </div>
              ...
              <div className="p-6 rounded-xl border border-white/5 border-dashed bg-slate-900/10 flex flex-col justify-center items-center text-center group cursor-not-allowed">
                ...
                <h3 className="text-slate-500 font-bold text-sm mb-1 uppercase tracking-tight group-hover:text-slate-400">Simple Questions</h3>
                <p className="text-slate-700 font-mono text-[10px]">INTERROGATIVE_FLOW</p>
              </div>
              ...
              <div className="p-6 rounded-xl border border-white/5 border-dashed bg-slate-900/10 flex flex-col justify-center items-center text-center group cursor-not-allowed">
                ...
                <h3 className="text-slate-500 font-bold text-sm mb-1 uppercase tracking-tight group-hover:text-slate-400">Travel Phrases</h3>
                <p className="text-slate-700 font-mono text-[10px]">TRANSIT_SURVIVAL</p>
              </div>
              ...
              <div className="p-6 rounded-xl border border-white/5 border-dashed bg-slate-900/10 flex flex-col justify-center items-center text-center group cursor-not-allowed">
                <div className="w-12 h-12 rounded-full bg-slate-900 border border-white/5 flex items-center justify-center mb-4 text-slate-700 group-hover:text-blue-400 group-hover:border-blue-500/20 transition-colors">
                  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-10V4m-5 10h.01M9 16h.01M9 20h.01M15 16h.01M15 20h.01M15 12h.01M15 8h.01" /></svg>
                </div>
                <h3 className="text-slate-500 font-bold text-sm mb-1 uppercase tracking-tight group-hover:text-slate-400">Seoul: City Life</h3>
                <p className="text-slate-700 font-mono text-[10px]">METROPOLITAN_DATA</p>
              </div>
              ...
              <div className="p-6 rounded-xl border border-white/5 border-dashed bg-slate-900/10 flex flex-col justify-center items-center text-center group cursor-not-allowed">
                ...
                <h3 className="text-slate-500 font-bold text-sm mb-1 uppercase tracking-tight group-hover:text-slate-400">Jeju: Island Life</h3>
                <p className="text-slate-700 font-mono text-[10px]">PROVINCIAL_DATA</p>
              </div>
              ...
              <div className="p-6 rounded-xl border border-white/5 border-dashed bg-slate-900/10 flex flex-col justify-center items-center text-center group cursor-not-allowed">
                ...
                <h3 className="text-slate-500 font-bold text-sm mb-1 uppercase tracking-tight group-hover:text-slate-400">Busan: Port Life</h3>
                <p className="text-slate-700 font-mono text-[10px]">MARITIME_DATA</p>
              </div>
